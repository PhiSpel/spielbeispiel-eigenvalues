...
def calculate_stiffness_matrix():
    nodes, members, member_angles, member_lengths, A, E = state.all_nodes, state.members, state.member_angles, state.member_lengths, state.A, state.E
...
def calculate_node_masses_and_member_lengths():
    nodes, members, rho, A, gridsize = state.all_nodes, state.members, state.rho, state.A, state.gridsize
    ...
    state.node_masses, state.member_lengths, state.member_angles = node_masses, member_lengths, member_angles


def calculate_forces():
    nodes, f_ext, node_masses, gravity = state.all_nodes, state.f_ext, state.node_masses, state.gravity
...
def reduce_matrix(A):
    nodes, rods_per_node, support = state.all_nodes, state.rods_per_node, state.support
