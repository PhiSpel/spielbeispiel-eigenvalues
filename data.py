...
def check_data():
    nodes, members, support, f_ext = state.all_nodes, state.members, state.support, state.f_ext
    ...
    state.rods_per_node, state.connected_nodes, state.issquare, state.forces_connected = rods_per_node, connected_nodes, issquare, forces_connected


def update_data_static():
    nodes, members, support, f_ext, debug, rods_per_node = state.all_nodes, state.members, state.support, state.f_ext, state.debug, state.rods_per_node
    ...
    if debug:
        ...
        st.write('connected nodes: ' + str(state.connected_nodes))
    ...
    state.matrix, state.rhs, state.internal_forces = matrix, rhs, internal_forces


# maybe use @st.cache()?
def update_data():
    nodes, members, support, f_ext, debug, rods_per_node, gravity, node_masses = state.all_nodes, state.members, state.support, state.f_ext, state.debug, state.rods_per_node, state.gravity, state.node_masses
    buildonly = False
    update_data_static()
